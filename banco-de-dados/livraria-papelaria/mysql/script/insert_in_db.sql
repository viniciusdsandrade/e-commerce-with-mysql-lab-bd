...
VALUES (1, 'pbkdf2_sha256$150000$example1$', NULL, 0, 'user1', 'Alice', 'Smith', 'alice@example.com', 0, 1, datetime('now')),
       (2, 'pbkdf2_sha256$150000$example2$', NULL, 0, 'user2', 'Bob', 'Johnson', 'bob@example.com', 0, 1, datetime('now')),
       (3, 'pbkdf2_sha256$150000$example3$', NULL, 0, 'user3', 'Carol', 'Williams', 'carol@example.com', 0, 1, datetime('now')),
       (4, 'pbkdf2_sha256$150000$example4$', NULL, 0, 'user4', 'David', 'Brown', 'david@example.com', 0, 1, datetime('now')),
       (5, 'pbkdf2_sha256$150000$example5$', NULL, 0, 'user5', 'Eve', 'Davis', 'eve@example.com', 0, 1, datetime('now')),
       (6, 'pbkdf2_sha256$870000$example7$', NULL, 0, 'user7', 'Frank', 'Wilson', 'frank@example.com', 0, 1, datetime('now')),
        (7, 'pbkdf2_sha256$870000$example8$', NULL, 0, 'user8', 'Grace', 'Martinez', 'grace@example.com', 0, 1, datetime('now')),
        (8, 'pbkdf2_sha256$870000$example9$', NULL, 0, 'user9', 'Henry', 'Anderson', 'henry@example.com', 0, 1, datetime('now')),
        (9, 'pbkdf2_sha256$870000$example10$', NULL, 0, 'user10', 'Ivy', 'Thomas', 'ivy@example.com', 0, 1, datetime('now')),
        (10, 'pbkdf2_sha256$870000$example11$', NULL, 0, 'user11', 'Jack', 'Roberts', 'jack@example.com', 0, 1, datetime('now')),
        (11, 'pbkdf2_sha256$870000$example12$', NULL, 0, 'user12', 'Kelly', 'Evans', 'kelly@example.com', 0, 1, datetime('now')),
        (12, 'pbkdf2_sha256$870000$example13$', NULL, 0, 'user13', 'Liam', 'Perez', 'liam@example.com', 0, 1, datetime('now')),
        (13, 'pbkdf2_sha256$870000$example14$', NULL, 0, 'user14', 'Mia', 'Garcia', 'mia@example.com', 0, 1, datetime('now')),
        (14, 'pbkdf2_sha256$870000$example15$', NULL, 0, 'user15', 'Noah', 'Rodriguez', 'noah@example.com', 0, 1, datetime('now')),
        (15, 'pbkdf2_sha256$870000$example16$', NULL, 0, 'user16', 'Olivia', 'Lopez', 'olivia@example.com', 0, 1, datetime('now')),
        (16, 'pbkdf2_sha256$870000$example17$', NULL, 0, 'user17', 'Peter', 'Hernandez', 'peter@example.com', 0, 1, datetime('now')),
        (17, 'pbkdf2_sha256$870000$example18$', NULL, 0, 'user18', 'Quinn', 'Gonzalez', 'quinn@example.com', 0, 1, datetime('now')),
        (18, 'pbkdf2_sha256$870000$example19$', NULL, 0, 'user19', 'Rose', 'Parker', 'rose@example.com', 0, 1, datetime('now')),
        (19, 'pbkdf2_sha256$870000$example20$', NULL, 0, 'user20', 'Sam', 'Morris', 'sam@example.com', 0, 1, datetime('now')),
        (20, 'pbkdf2_sha256$870000$example21$', NULL, 0, 'user21', 'Tom', 'Young', 'tom@example.com', 0, 1, datetime('now')),
       (21, 'pbkdf2_sha256$870000$2IZXgyAwNkEC7SxrWQGSgG$/pXObGzJG2+7LAoaJsORb9Y4j5lfXHGQ0AthGPV+UJc=', NULL, 1,
       'admin', 'Admin', 'Admin', 'admin@example.com', 1, 1, datetime('now'));
...
VALUES (1, datetime('now'), 1, 1),
        ...
        (8, datetime('now'), 8, 9),
        (9, datetime('now'), 9, 10),
        (10, datetime('now'), 10, 11),
        (11, datetime('now'), 11, 12),
        (12, datetime('now'), 12, 13),
        (13, datetime('now'), 13, 14),
        (14, datetime('now'), 14, 15),
        (15, datetime('now'), 15, 16),
        (16, datetime('now'), 16, 17),
        (17, datetime('now'), 17, 18),
        (18, datetime('now'), 18, 19),
        (19, datetime('now'), 19, 20),
        (20, datetime('now'), 1, 2);
...
INSERT INTO app_entrega (compra_produto_id, codigo_rastreio, data_postado, data_transito, data_recebido, estado,
                         transportadora_id)
VALUES (1, 'ABC123456', datetime('now'), datetime('now'), datetime('now'), 'Entregue', 1),
       (2, 'DEF234567', datetime('now'), datetime('now'), datetime('now'), 'Entregue', 2),
       (3, 'GHI345678', datetime('now'), datetime('now'), NULL, 'Em trânsito', 3),
       (4, 'JKL456789', datetime('now'), NULL, NULL, 'Postado', 4),
       (5, 'MNO567890', datetime('now'), NULL, NULL, 'Em trânsito', 5),
       (6, 'PQR678901', datetime('now'), datetime('now'), datetime('now'), 'Entregue', 6),
       (7, 'STU789012', datetime('now'), datetime('now'), datetime('now'), 'Entregue', 7),
       (8, 'VWX890123', datetime('now'), datetime('now'), NULL, 'Em trânsito', 8),
       (9, 'YZA901234', datetime('now'), NULL, NULL, 'Postado', 9),
       (10, 'BCD012345', datetime('now'), NULL, NULL, 'Em trânsito', 10),
       (11, 'EFG123456', datetime('now'), datetime('now'), datetime('now'), 'Entregue', 11),
       (12, 'HIJ234567', datetime('now'), datetime('now'), datetime('now'), 'Entregue', 12),
       (13, 'KLM345678', datetime('now'), datetime('now'), NULL, 'Em trânsito', 13),
       (14, 'NOP456789', datetime('now'), NULL, NULL, 'Postado', 14),
       (15, 'PQR567890', datetime('now'), NULL, NULL, 'Em trânsito', 15),
       (16, 'STU678901', datetime('now'), datetime('now'), datetime('now'), 'Entregue', 16),
       (17, 'VWX789012', datetime('now'), datetime('now'), datetime('now'), 'Entregue', 17),
       (18, 'YZA890123', datetime('now'), datetime('now'), NULL, 'Em trânsito', 18),
       (19, 'BCD901234', datetime('now'), NULL, NULL, 'Postado', 19),
       (20, 'EFG012345', datetime('now'), NULL, NULL, 'Em trânsito', 20),
        (21, 'HIJ123456', datetime('now'), datetime('now'), datetime('now'), 'Entregue', 1),
        (22, 'KLM234567', datetime('now'), datetime('now'), datetime('now'), 'Entregue', 2),
        (23, 'NOP345678', datetime('now'), datetime('now'), NULL, 'Em trânsito', 3),
        (24, 'PQR456789', datetime('now'), NULL, NULL, 'Postado', 4),
        (25, 'STU567890', datetime('now'), NULL, NULL, 'Em trânsito', 5),
        (26, 'VWX678901', datetime('now'), datetime('now'), datetime('now'), 'Entregue', 6),
        (27, 'YZA789012', datetime('now'), datetime('now'), datetime('now'), 'Entregue', 7),
        (28, 'BCD890123', datetime('now'), datetime('now'), NULL, 'Em trânsito', 8),
        (29, 'EFG901234', datetime('now'), NULL, NULL, 'Postado', 9),
        (30, 'HIJ012345', datetime('now'), NULL, NULL, 'Em trânsito', 10),
        (31, 'KLM123456', datetime('now'), datetime('now'), datetime('now'), 'Entregue', 11),
        (32, 'NOP234567', datetime('now'), datetime('now'), datetime('now'), 'Entregue', 12),
        (33, 'PQR345678', datetime('now'), datetime('now'), NULL, 'Em trânsito', 13),
        (34, 'STU456789', datetime('now'), NULL, NULL, 'Postado', 14),
        (35, 'VWX567890', datetime('now'), NULL, NULL, 'Em trânsito', 15),
        (36, 'YZA678901', datetime('now'), datetime('now'), datetime('now'), 'Entregue', 16),
        (37, 'BCD789012', datetime('now'), datetime('now'), datetime('now'), 'Entregue', 17),
        (38, 'EFG890123', datetime('now'), datetime('now'), NULL, 'Em trânsito', 18),
        (39, 'HIJ901234', datetime('now'), NULL, NULL, 'Postado', 19),
        (40, 'KLM012345', datetime('now'), NULL, NULL, 'Em trânsito', 20);
...
VALUES (1, 'PROMO10', 10.00, datetime('now'), datetime('now')),
       (2, 'PROMO20', 20.00, datetime('now'), datetime('now')),
       (3, 'PROMO30', 30.00, datetime('now'), datetime('now')),
       (4, 'PROMO40', 40.00, datetime('now'), datetime('now')),
       (5, 'PROMO50', 50.00, datetime('now'), datetime('now')),
        (6, 'PROMO60', 60.00, datetime('now'), datetime('now')),
        (7, 'PROMO70', 70.00, datetime('now'), datetime('now')),
        (8, 'PROMO80', 80.00, datetime('now'), datetime('now')),
        (9, 'PROMO90', 90.00, datetime('now'), datetime('now')),
        (10, 'PROMO100', 100.00, datetime('now'), datetime('now')),
        (11, 'PROMO110', 110.00, datetime('now'), datetime('now')),
        (12, 'PROMO120', 120.00, datetime('now'), datetime('now')),
        (13, 'PROMO130', 130.00, datetime('now'), datetime('now')),
        (14, 'PROMO140', 140.00, datetime('now'), datetime('now')),
        (15, 'PROMO150', 150.00, datetime('now'), datetime('now')),
        (16, 'PROMO160', 160.00, datetime('now'), datetime('now')),
        (17, 'PROMO170', 170.00, datetime('now'), datetime('now')),
        (18, 'PROMO180', 180.00, datetime('now'), datetime('now')),
        (19, 'PROMO190', 190.00, datetime('now'), datetime('now')),
        (20, 'PROMO200', 200.00, datetime('now'), datetime('now'));
...
VALUES (1, 'Promoção de Verão', datetime('now'), datetime('now')),
       (2, 'Promoção de Inverno', datetime('now'), datetime('now')),
       ...
       (5, 'Promoção de Natal', '2024-12-20', '2024-12-26'),
        ...
        (7, 'Promoção de Verão', datetime('now'), datetime('now')),
        (8, 'Promoção de Inverno', datetime('now'), datetime('now')),
        ...
        (13, 'Promoção de Verão', datetime('now'), datetime('now')),
        (14, 'Promoção de Inverno', datetime('now'), datetime('now')),
        ...
        (19, 'Promoção de Verão', datetime('now'), datetime('now')),
        (20, 'Promoção de Inverno', datetime('now'), datetime('now'));
