...
VALUES (1, 'pbkdf2_sha256$150000$example1$', NULL, 0, 'user1', 'Alice', 'Smith', 'alice@example.com', 0, 1, NOW()),
       ...
       (16, 'pbkdf2_sha256$870000$example17$', NULL, 0, 'user17', 'Peter', 'Hernandez', 'peter@example.com', 0, 1,
        NOW()),
       (17, 'pbkdf2_sha256$870000$example18$', NULL, 0, 'user18', 'Quinn', 'Gonzalez', 'quinn@example.com', 0, 1,
        NOW()),
...
VALUES (1, 'O Mistério da Casa Abandonada', 29.99, 'Um suspense intrigante sobre uma casa cheia de segredos.', 1),
...
INSERT INTO app_cartao (id, numero, validade, codigo_seguranca, nome_dono, tipo)
...
INSERT INTO app_entrega (compra_produto_id, codigo_rastreio, data_postado, data_transito, data_recebido, estado,
                         transportadora_id)
VALUES (1, 'ABC123456', NOW(), NOW(), NOW(), 'Entregue', 1),
       (2, 'DEF234567', NOW(), NOW(), NOW(), 'Entregue', 2),
       (3, 'GHI345678', NOW(), NOW(), NULL, 'Em trânsito', 3),
       (4, 'JKL456789', NOW(), NULL, NULL, 'Postado', 4),
       (5, 'MNO567890', NOW(), NULL, NULL, 'Em trânsito', 5),
       (6, 'PQR678901', NOW(), NOW(), NOW(), 'Entregue', 6),
       (7, 'STU789012', NOW(), NOW(), NOW(), 'Entregue', 7),
       (8, 'VWX890123', NOW(), NOW(), NULL, 'Em trânsito', 8),
       (9, 'YZA901234', NOW(), NULL, NULL, 'Postado', 9),
       (10, 'BCD012345', NOW(), NULL, NULL, 'Em trânsito', 10),
       (11, 'EFG123456', NOW(), NOW(), NOW(), 'Entregue', 11),
       (12, 'HIJ234567', NOW(), NOW(), NOW(), 'Entregue', 12),
       (13, 'KLM345678', NOW(), NOW(), NULL, 'Em trânsito', 13),
       (14, 'NOP456789', NOW(), NULL, NULL, 'Postado', 14),
       (15, 'PQR567890', NOW(), NULL, NULL, 'Em trânsito', 15),
       (16, 'STU678901', NOW(), NOW(), NOW(), 'Entregue', 16),
       (17, 'VWX789012', NOW(), NOW(), NOW(), 'Entregue', 17),
       (18, 'YZA890123', NOW(), NOW(), NULL, 'Em trânsito', 18),
       (19, 'BCD901234', NOW(), NULL, NULL, 'Postado', 19),
       (20, 'EFG012345', NOW(), NULL, NULL, 'Em trânsito', 20),
       (21, 'HIJ123456', NOW(), NOW(), NOW(), 'Entregue', 1),
       (22, 'KLM234567', NOW(), NOW(), NOW(), 'Entregue', 2),
       (23, 'NOP345678', NOW(), NOW(), NULL, 'Em trânsito', 3),
       (24, 'PQR456789', NOW(), NULL, NULL, 'Postado', 4),
       (25, 'STU567890', NOW(), NULL, NULL, 'Em trânsito', 5),
       (26, 'VWX678901', NOW(), NOW(), NOW(), 'Entregue', 6),
       (27, 'YZA789012', NOW(), NOW(), NOW(), 'Entregue', 7),
       (28, 'BCD890123', NOW(), NOW(), NULL, 'Em trânsito', 8),
       (29, 'EFG901234', NOW(), NULL, NULL, 'Postado', 9),
       (30, 'HIJ012345', NOW(), NULL, NULL, 'Em trânsito', 10),
       (31, 'KLM123456', NOW(), NOW(), NOW(), 'Entregue', 11),
       (32, 'NOP234567', NOW(), NOW(), NOW(), 'Entregue', 12),
       (33, 'PQR345678', NOW(), NOW(), NULL, 'Em trânsito', 13),
       (34, 'STU456789', NOW(), NULL, NULL, 'Postado', 14),
       (35, 'VWX567890', NOW(), NULL, NULL, 'Em trânsito', 15),
       (36, 'YZA678901', NOW(), NOW(), NOW(), 'Entregue', 16),
       (37, 'BCD789012', NOW(), NOW(), NOW(), 'Entregue', 17),
       (38, 'EFG890123', NOW(), NOW(), NULL, 'Em trânsito', 18),
       (39, 'HIJ901234', NOW(), NULL, NULL, 'Postado', 19),
...
INSERT INTO app_transportadora (id, nome, cnpj, inscricao_estadual, preco_km)
...
VALUES (1, 'PROMO10', 10.00, NOW(), NOW()),
       (2, 'PROMO20', 20.00, NOW(), NOW()),
       (3, 'PROMO30', 30.00, NOW(), NOW()),
       (4, 'PROMO40', 40.00, NOW(), NOW()),
       (5, 'PROMO50', 50.00, NOW(), NOW()),
       (6, 'PROMO60', 60.00, NOW(), NOW()),
       (7, 'PROMO70', 70.00, NOW(), NOW()),
       (8, 'PROMO80', 80.00, NOW(), NOW()),
       (9, 'PROMO90', 90.00, NOW(), NOW()),
       (10, 'PROMO100', 100.00, NOW(), NOW()),
       (11, 'PROMO110', 110.00, NOW(), NOW()),
       (12, 'PROMO120', 120.00, NOW(), NOW()),
       (13, 'PROMO130', 130.00, NOW(), NOW()),
       (14, 'PROMO140', 140.00, NOW(), NOW()),
       (15, 'PROMO150', 150.00, NOW(), NOW()),
       (16, 'PROMO160', 160.00, NOW(), NOW()),
       (17, 'PROMO170', 170.00, NOW(), NOW()),
       (18, 'PROMO180', 180.00, NOW(), NOW()),
       (19, 'PROMO190', 190.00, NOW(), NOW()),
       (20, 'PROMO200', 200.00, NOW(), NOW());
...
VALUES (1, 'Promoção de Verão', NOW(), NOW()),
       (2, 'Promoção de Inverno', NOW(), NOW()),
       ...
       (7, 'Promoção de Verão', NOW(), NOW()),
       (8, 'Promoção de Inverno', NOW(), NOW()),
       ...
       (13, 'Promoção de Verão', NOW(), NOW()),
       (14, 'Promoção de Inverno', NOW(), NOW()),
       ...
       (19, 'Promoção de Verão', NOW(), NOW()),
       (20, 'Promoção de Inverno', NOW(), NOW());
...
DELETE FROM app_promocaoproduto;
DELETE FROM app_promocao;
DELETE FROM app_cupom_compras;
DELETE FROM app_cupom;
DELETE FROM app_entrega;
DELETE FROM app_compraproduto;
DELETE FROM app_transportadora;
DELETE FROM app_avaliacao;
DELETE FROM app_endereco;
DELETE FROM app_pix;
DELETE FROM app_cartao;
DELETE FROM app_listadesejos_produtos;
DELETE FROM app_listadesejos;
DELETE FROM app_carrinhoproduto;
DELETE FROM app_carrinho;
DELETE FROM app_estoque;
DELETE FROM app_categoria_produtos;
DELETE FROM app_produto;
