...
BEGIN
    DECLARE EXIT HANDLER FOR SQLEXCEPTION
        BEGIN
            -- Se ocorrer algum erro, execute o rollback
            ROLLBACK;
            SELECT 'Erro durante as inserções. Rollback realizado.' AS Resultado;
        END;
    ...
    COMMIT;
    SELECT 'Inserções realizadas com sucesso. Transação confirmada.' AS Resultado;
END$$
DELIMITER ;
