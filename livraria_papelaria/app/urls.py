...
urlpatterns = [
    ...
    path('usuario/formas_pagamento_criar/<str:tipo_pagamento>', views.formas_pagamento_criar, name='formas_pagamento_criar'),
    path('usuario/formas_pagamento_remover/<str:tipo_pagamento>/<int:id_pagamento>', views.formas_pagamento_remover, name="formas_pagamento_remover"),
